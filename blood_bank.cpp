...
class admin{
    public:
        ...
        admin(){
            ...
            else cout<<"Please contact Ridam to become an admin"<<endl; 
        }
};
void admin::display(){
...
int patient::save(){
    ...
    cout<<"\t0) A+"<<endl<<"\t1) O+"<<endl<<"\t2) B+"<<endl<<"\t3) AB+"<<endl<<"\t4) A-"<<endl<<"\t5) O-"<<endl<<"\t6) B-"<<endl<<"\t7) AB-"<<endl<<"--> ";
    cin>>c;
    cout<<"You will be donated with 1 blood packet."<<endl;
    cout<<"Please login again to get 1 more blood packet."<<endl;
...
void patient::show(int c){
    ...
    if(c==0){
        ...
        else cout<<"Compatible blood group not available.\n";
